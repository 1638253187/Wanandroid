...
public class CircleImagesView extends AppCompatImageView {
    private float width;
    ...
    public CircleImagesView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImagesView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
